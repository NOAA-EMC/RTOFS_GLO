...
integer(i4)                       :: ncid
!!Alex call nciock(filename,nf90_create(path = trim(filename),cmode=NF90_64BIT_OFFSET, ncid = fid))
call nciock(filename,nf90_create(path = trim(filename),cmode=or(nf90_clobber, &
                                                       or(nf90_hdf5, &
                                                          nf90_classic_model)), ncid = fid))
...
call nciock(filename,nf90_enddef(fid))
end subroutine
...
subroutine nciorc(filename,fid)
        ...
        character(len=*), intent(in)      :: filename
        integer(i4), intent(in)           :: fid
        call nciock(filename,nf90_redef(fid))
end subroutine
...
integer(i4)                       :: dimid
call nciock(filename,nf90_def_dim(fid,trim(dimname), dimlen,dimid))
end subroutine
...
integer(i4)                       :: varid
call nciock(filename,nf90_def_var(fid,trim(vname),vtype,vdims, varid))
end subroutine
...
character(len=*), intent(in)      :: filename
integer(i4),      intent(out)     :: fid
call nciock(filename,nf90_open(trim(filename),nf90_Write,fid))
...
character(len=*), intent(in)      :: filename
integer(i4), intent(in)           :: fid
call nciock(filename,nf90_close(fid))
...
integer(i4)                       :: vardimid
call nciock(filename,nf90_inq_dimid(fid,trim(vname), vardimid))
call nciock(filename,nf90_inquire_dimension(fid,vardimid, len = nval))
end subroutine
...
integer(i4)                              :: vid
call nciock(filename,nf90_inq_varid(fid,trim(vname), vid))
if (present(start)) then
    call nciock(filename,nf90_get_var(fid, vid, values,start,count))
else
    call nciock(filename,nf90_get_var(fid, vid, values))
endif
end subroutine
...
call nciock(filename,nf90_inq_varid(fid,trim(vname), vid))
if (present(start)) then
    call nciock(filename,nf90_put_var(fid, vid, values,start,count))
else
    call nciock(filename,nf90_put_var(fid, vid, values))
endif
end subroutine
...
integer(i4)                              :: vid
call nciock(filename,nf90_inq_varid(fid,trim(vname), vid))
call nciock(filename,nf90_put_att(fid, vid, name,value))
end subroutine
...
real(r4),         intent(in)             :: value
integer(i4),   intent(in)                :: fid
call nciock(filename,nf90_put_att(fid, NF90_GLOBAL, name,value))
end subroutine
...
integer(i4),      intent(in)             :: fid
call nciock(filename,nf90_get_att(fid, NF90_GLOBAL, name,value))
end subroutine
...
integer(i4),      intent(in)             :: fid
integer(i4)                              :: vid
call nciock(filename,nf90_inq_varid(fid, namevar, vid))
call nciock(filename,nf90_get_att(fid, vid, nameatt, value))
end subroutine

!###
subroutine nciock(filename,istat)
use netcdf
implicit none
