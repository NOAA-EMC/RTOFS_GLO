...
!
! !REVISION HISTORY:
!  SVN:$Id: CICE_RunMod.F90 144 2008-08-12 21:37:19Z eclare $
!
...
!pgp
      logical, save, public :: end_of_run  !set in CICE_Run
      logical, save, public :: get_import  !set in CICE_InitMod
      logical, save, public :: put_export  !set in CICE_InitMod
...
!Alex move after CICE_CoupledFillExport
!done every time step, so all fluxes are for a single time step
         call init_flux_atm     ! initialize atmosphere fluxes sent to coupler
         call init_flux_ocn     ! initialize ocean fluxes sent to coupler

!pgp
      exit timeLoop     !timeLoop single time step per call
      enddo timeLoop
!
!EOC
!
