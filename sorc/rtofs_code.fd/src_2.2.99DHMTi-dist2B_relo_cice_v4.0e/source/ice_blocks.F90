...
!
! !REVISION HISTORY:
!  SVN:$Id: ice_blocks.F90 143 2008-08-08 23:08:22Z eclare $
!
...
! !PUBLIC DATA MEMBERS:
   ...
   integer, public, dimension(:,:,:), allocatable :: &
      deBlockList        ! global block locations for ESMF
#endif
!EOP
!BOC
!-----------------------------------------------------------------------
...
#ifdef USE_ESMF
   allocate(deBlockList(2,2,nblocks_tot))  !filled by create_deBlockList
#endif
