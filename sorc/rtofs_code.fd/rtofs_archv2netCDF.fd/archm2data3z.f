...
c --- 'mltio ' = mix. lay. thick. I/O unit (0 no I/O), choose 2 of 3 kinds:
c --- 'tmljmp' = equiv. temp. jump across mixed-layer (degC,  0 no I/O) or
...
c
c ---   ---------------------------------
c ---   eqivalent temperature mixed layer
c ---   ---------------------------------
c
