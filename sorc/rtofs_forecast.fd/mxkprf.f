...
c
      ...
      parameter (ldebug_dpmixl=.false.)
c
      real      delp,hblmax,sigmlj,thsur,thtop,thbot,alfadt,betads,
     &          thjmp(kdm),thloc(kdm)
      integer   i,j,k,l
      character text*12
c
...
!$OMP&                      sigmlj,thsur,thtop,thbot,alfadt,betads,
!$OMP&                      thjmp,thloc)
!$OMP&         SCHEDULE(STATIC,jblk)
        do j=1-margin,jj+margin
          do l=1,isp(j)
...
*
     ...
     &                thsur,thtop,thbot,dpmixl(i,j,n)*qonem
                  endif
*
