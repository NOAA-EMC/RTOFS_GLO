c-----------------------------------------------------------------------------
     ...
     &                corio,psikk,thkk,potvor,srfhgt,montg1,
...
c --- difsmo      KPROF: activate horiz smooth diff coeffs
...
c
     ...
     &              locsig,vsigma,hybrid,isopyc,icegln,
     &              mxlkta,mxlktb,mxlkrt,pensol,
     &              mxlkpp,bblkpp,shinst,dbdiff,nonloc,
     &              latdiw,botdiw,difsmo,difout,
...
c
     ...
     &               dsurfq,diagfq,meanfq,rstrfq,bnstfq,nestfq,
...
c
     ...
     &               flxflg,empflg,lwflag,sstflg,sssflg
