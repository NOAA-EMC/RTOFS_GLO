...
c
     ...
     & dpmn
c
      integer i,iflip,isave,j,jsave,k,l,ia,ib,ja,jb,mbdy
...
cdiag           write (lp,'(i9,2i5,i3,a,f11.5,i4)') nstep,i+i0,j+j0,k,
cdiag.          '  neg. dp after thknss smoothing',
cdiag.          p(i,j,k+1)-p(i,j,k),iflip
                p(i,j,k+1)=p(i,j,k)
              endif
