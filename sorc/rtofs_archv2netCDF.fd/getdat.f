...
c
      ...
      subroutine getdat(flnm,time,artype,initl,icegln,trcout,
...
c ---   HYCOM 1.0 pakked archive file.
     ...
     &               iexpt,iversn,yrflag,kkin, util,work)
      ...
      subroutine getdats(flnm,time,artype,initl,icegln,trcout,
     &                   iexpt,iversn,yrflag,kkin)
      use mod_plot  ! HYCOM plot array interface
      use mod_za    ! HYCOM array I/O interface
      implicit none
...
c ---   HYCOM 1.0 pakked archive file.
     ...
     &               iexpt,iversn,yrflag,kkin, util,work)
      ...
      subroutine getdatb(flnm,time,artype,initl,icegln,trcout,
     &                   iexpt,iversn,yrflag,kkin)
      use mod_plot  ! HYCOM plot array interface
      use mod_za    ! HYCOM array I/O interface
      implicit none
