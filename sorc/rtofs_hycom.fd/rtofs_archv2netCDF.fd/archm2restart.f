...
c
      kkin  = kk
      kk    = 0       !define kkmax here, rather than in plot_alloc
      kkmax = 2*kkin  !room for two time levels
      call plot_alloc
      kk = kkin
*
...
c
      if (lhycom) then
        call getdat(flnmarch,time3,artype,initl,icegln,trcout,
