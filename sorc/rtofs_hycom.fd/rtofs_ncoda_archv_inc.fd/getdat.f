...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA0_7term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA2_7term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA0_9term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA2_9term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA0_17term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA2_17term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA0_12term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA2_12term.h'
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA4_17term.h'
      include './stmt_fns_SIGMA4_17term.h'
c
      do j= 1,mo
        do i= 1,no
          if     (temp(i,j).ne.spval) then
...
c
      integer i,j
c
c     include '../../include/stmt_fns_SIGMA4_12term.h'
      include './stmt_fns_SIGMA4_12term.h'
c
      do j= 1,mo
        do i= 1,no
          if     (temp(i,j).ne.spval) then
