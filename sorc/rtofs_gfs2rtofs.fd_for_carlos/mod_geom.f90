...
private
implicit none
public hycom_na_mercator, hycom_global_tripolar,hycom_na,mrf_gaussian,rd_hycom_grid_params,mask_mrf,mask_hycom_1,mask_hycom_2,horiz_intp,horiz_intp_ !!$$ ,extend_fld
!
...
!========================================================================
!
  subroutine hycom_global_tripolar_read(exhycom,eyhycom,dbgn)
  integer, intent(in) :: dbgn
  real, dimension(:),intent(out) :: exhycom
  real, dimension(:),intent(out) :: eyhycom
  integer nxhycom,nyhycom,i
...
!   Fix ithsmus problem.
!
! ilya; ismus correction is not ready for this grid
    if (mapflg/=mapflg_tripol)  call ismus(flx)
!
