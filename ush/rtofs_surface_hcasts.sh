...
# for nowcast for the U.S. Coast Guard and post to ftp.
#
# Input Files:
#          $COMOUT/rtofs.${yyyymmdd}/rtofs_glo_2ds_${fcast}_1hrly_prog.nc
#          for fcast = 00 through 24 hours at 3 hour time-step
#
