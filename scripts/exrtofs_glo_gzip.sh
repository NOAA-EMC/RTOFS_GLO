...
# sort files from largest to smallest for cfp efficiency
	for file in `echo ${COMIN}/${filepre}.n*.restart.a;  echo ${COMIN}/${filepre}.n*.restart_cice;  echo ${COMIN}/${filepre}.n-{06..24..6}.archv.a;  echo ${COMIN}/${filepre}.n-03.archv.a;  echo ${COMIN}/${filepre}.n00.archv.a;  echo ${COMIN}/${filepre}.n00.arche.a;  echo ${COMIN}/${filepre}.n-{01..24}.arche.a;  echo ${COMIN}/${filepre}.n00.archs.a;  echo ${COMIN}/${filepre}.n-{01..24}.archs.a`
	do
	    if [ -s $file ]; then
